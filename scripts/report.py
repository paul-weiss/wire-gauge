...
instead of silent loss. No dependencies; everything else is measured against this.</dd>
...
vendored C client, statically linked.</dd>
...
“don't hand-roll it” IPC candidate.</dd>
</dl>
</section>
<section>
...
message), no framework anywhere in the path.</dd>
...
floor of the network axis — the delta to aeron-udp prices Aeron's reliability layer.</dd>
...
so a send is on the wire before it returns.</dd>
...
XADD is a full client–server round trip, so over-offered load shows up as send lag.</dd>
...
and saturation becomes queueing delay the schedule-honest harness can see.</dd>
</dl>
</section>
</div>"""
